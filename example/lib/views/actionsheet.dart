...
final options = [
  WeActionsheetItem(label: '选项一', value: '1'),
  WeActionsheetItem(label: '选项二', value: '2'),
  WeActionsheetItem(label: '选项三', value: '3')
];

class ActionsheetPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final WeActionsheetAndroid actionsheetAndroid =
        WeActionsheet.android(context);
